    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 col-sm-8 col-12 col-lg-6 col-xl-6">
                <div class="card">
                    <div class="text-center mt-3 h2">{{ __('Enter Verification Code') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('emailCodeVerification.code') }}">
                            @csrf
                            <div class="form-group row justify-content-center align-items-center">
                                <div class="col-md-8 col-sm-8 col-8 col-lg-8 col-xl-8">
                                    <input id="email_code" type="text" class="ms-2 form-control @error('email_code') is-invalid @enderror" name="email_code" required pattern="[0-9]*" maxlength="6">
                                    @error('email_code')
