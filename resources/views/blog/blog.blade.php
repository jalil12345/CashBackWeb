...
<spam class="h2 fw-bold ">Macklara Blog</spam><br><br>
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 row-cols-xlg-3">
<div class="col "> 

   <div class="card border-success mb-3 " style="max-width:  ; "> <!-- height: 200px; -->
