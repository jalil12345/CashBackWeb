...
@section('content')
  ...
  <button class="btn btn-custom-pink me-md-2" type="button">Account Details</button>
  <button class="btn btn-primary" type="button">Payouts</button>
  </div>
<br>
<div class="container "> <div class="card ">
  <div class="row">
  <div class="col-6"><br><br><p class="text-center h1  ">{{ __('  ') }}{{ Auth::user()->name }}</p>
                     <p class="text-center h5 ">{{ __(' Email : ') }}{{ Auth::user()->email }}</p></div>
